...
const EditAdvisor = () => {
  ...
  const [formData, setFormData] = useState({
    username: advisorData?.advisorname || '',
    emailaddress: advisorData?.mailID || '',
    password: '',
    confirmpassword: '',
    joiningdate: '',
    designation: 'Service Advsior',
    branchname: advisorData?.location || '',
    branchlocation: advisorData?.location || '',
    Department: '',
    status: advisorData?.status || 'Active',
  })
      ...
      <section className='edit-advisor'>
        ...
        <form>
          ...
          <div className='edit-form mt-4'>
            <h5 className='editadvisor-heading'>Branch Information</h5>
            <Row className='add-fields'>
