...
const EditAdvisor = () => {
  ...
  const initialValues = {
    ...
    emailAddress: advisorData?.emailAddress || '',
    ...
    companyAddress: advisorData?.companyAddress || '',
    pincode: advisorData?.pincode || '',
    department: advisorData?.department || '',
    serviceType: advisorData?.serviceType || '',
    status: advisorData?.status ? "Active" : "In Active",
  }
