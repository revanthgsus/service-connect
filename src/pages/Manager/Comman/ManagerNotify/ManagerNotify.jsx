...
const ManagerNotify = ({ isOpen, toggleNotify }) => {
  ...
  const fetchNotifications = useCallback(async () => {
    ...
    try {
      const response = await axios.get(`${API_BASE_URL}/managerMaster/viewNotificationsByCompanyNameAndLocation/${companyName}/${companyLocation}`,
        {
          headers: {
  ...
  return (
    <>
      <div className='manager-notification' ref={notifyRef}>
