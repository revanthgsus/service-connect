...
import ManagerNotify from '../ManagerNotify/ManagerNotify';

const ManagerNavbar = ({ handleDrawerToggle, isOpen, menuBtnRef }) => {
      ...
      <Navbar expand={false} className="manager-navbar fixed-top" >
        <Container fluid className="px-4">
          ...
          <div className="navbar-icons">
            <ManagerNotify isOpen={activeDropdown === 'notify'}
            ...
            <ManagerDropdown isOpen={activeDropdown === 'dropdown'}
