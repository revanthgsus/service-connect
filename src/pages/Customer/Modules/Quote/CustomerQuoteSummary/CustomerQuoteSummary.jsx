...
const CustomerQuoteSummary = () => {
                  ...
                  : quote.warrantyStatus === "Claimed" ? "claimed"
                    : quote.warrantyStatus === "Declined" ? "declined"
                      : quote.warrantyStatus === "Already Claimed" ? "alreadyclaimed"
                        : quote.warrantyStatus === "View & claim" ? "disabled" : ""}`}>

            {/* staus change in UI level */}
            {quote.warrantyStatus === "No" ? ""
              : quote.warrantyStatus === "View & claim" ? "Warranty Covered"
  ...
  return (
    <QuoteSummary
      apiUrl="customerMaster/updateQuoteStatus"
...
export default CustomerQuoteSummary;